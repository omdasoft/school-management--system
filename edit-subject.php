        ...
        <div class="content-wrapper">
            ...
            <?php
                if(isset($_GET['subject_no'])) {
                    ...
                    $qry = "SELECT * FROM subjects WHERE id = ? LIMIT 1";
                        ...
                        <div class="card-body">
                            <form method="post" action="update-subject.php">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="subject_name" id="subject_name" value="<?php echo $row['name']; ?>" placeholder="Class Name" required>
