            ...
            <section class="content">
                <div class="container-fluid">
                    <table id="class" class="table table-bordered table-hover">
                        <thead>
                            <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending">Class No</th>
                            ...
                            <?php if($num > 0) {  ?>
                                <?php foreach($classes as $class) { ?>
                                    ...
                                    <tr role="row" class="odd">
                                        <td class="sorting_1"><?php echo $class['id']; ?></td>
                        ...
                        <tfoot>
                            <tr>
                                <th rowspan="1" colspan="1">Class No</th>
